...
public class CreateESIAFrame extends ModuleGUI {
    public JTextField TID;
    public JTextField TSNILSOper;
    public JTextField TRA;
    public JTextField TSNILS;
    public JTextField TName;
    public JTextField TSurname;
    public JTextField TMiddleName;
